# Grow and Care App
Welcome to the Grow and Care App public repo. This project is our first web application that is object-oriented and built using the Angular framework with TypeScript. It provides a user-friendly interface for managing your plants, accessing care instructions, and tracking transactions related to your plants. 
